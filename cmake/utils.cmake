...
if(NOT EXISTS ${_MRT_LIB_CACHE})
    file(MAKE_DIRECTORY ${_MRT_LIB_CACHE})
endif()

if(DEFINED ENV{MRTLIBS_SERVER} AND NOT ENABLE_GITEE)
    set(LOCAL_LIBS_SERVER  $ENV{MRTLIBS_SERVER})
