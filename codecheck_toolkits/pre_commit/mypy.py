...
FILES = [
    "vllm_mindspore/*.py",
    "vllm_mindspore/entrypoints",
    "vllm_mindspore/inputs",
    "vllm_mindspore/multimodal",
    "vllm_mindspore/platforms"
]
...
SEPARATE_GROUPS = [
    "tests",
    "vllm_mindspore/distributed",
    "vllm_mindspore/engine",
    "vllm_mindspore/executor",
    "vllm_mindspore/inputs",
    "vllm_mindspore/lora",
    "vllm_mindspore/model_executor",
    "vllm_mindspore/v1",
]
