...
ALLOWED_FILES = {
    # pickle
    'vllm_mindspore/v1/serial_utils.py',
    'vllm_mindspore/v1/executor/multiproc_executor.py',
    'vllm_mindspore/multimodal/hasher.py',
    'vllm_mindspore/transformers_utils/config.py',
    'vllm_mindspore/model_executor/models/registry.py',
    'tests/utils_/test_utils.py',
    'tests/tokenization/test_cached_tokenizer.py',
    'vllm_mindspore/distributed/utils.py',
    'vllm_mindspore/distributed/parallel_state.py',
    'vllm_mindspore/distributed/device_communicators/all_reduce_utils.py',
    'vllm_mindspore/distributed/device_communicators/shm_broadcast.py',
    'vllm_mindspore/distributed/device_communicators/shm_object_storage.py',
    ...
    # cloudpickle
    'vllm_mindspore/worker/worker_base.py',
    'vllm_mindspore/executor/mp_distributed_executor.py',
    'vllm_mindspore/executor/ray_distributed_executor.py',
    'vllm_mindspore/entrypoints/llm.py',
    'tests/utils.py',
    # pickle and cloudpickle
    'vllm_mindspore/utils/__init__.py',
}
