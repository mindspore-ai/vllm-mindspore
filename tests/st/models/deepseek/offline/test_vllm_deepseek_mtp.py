...
@pytest.mark.level0
def test_deepseek_r1_mtp():
    """
    Test Summary:
        Test case deepseek r1 mtp inference.
    Expected Result:
    ...
    except_list = [
        'ugs611ాలు哒ాలు mah战区rollerOVERlaid',
        'ugs611ాలు哒ాలు unattended的人工ollis Lazar'
    ]
    # Print the outputs.
    for i, output in enumerate(outputs):
        ...
        # the result may exhibit random fluctuations
