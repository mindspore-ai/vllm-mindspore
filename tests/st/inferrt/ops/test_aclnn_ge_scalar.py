...
def op_func(x):
    """golden for ge_scalar"""
    return x >= 0.5


def get_op_func_compiled():
    """ge_scalar op compiled"""
...
def test_ge_scalar(shape, dtype):
    """
    Feature: Test op ge_scalar
    Description: Test op ge_scalar with multi-dimensional tensor inputs
