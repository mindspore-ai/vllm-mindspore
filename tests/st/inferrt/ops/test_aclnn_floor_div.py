...
def test_floor_div(pipeline, monkeypatch, shape):
    """
    Feature: Test aclnn floor div
    Description: Test aclnn floor div and with different dtype inputs and different shape
