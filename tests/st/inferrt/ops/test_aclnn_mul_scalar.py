...
"""Tests for mul_scalar operation."""
import pytest
import torch
...
def op_func(x):
    """golden for mul_scalar"""
    return x * 2.5


def get_op_func_compiled():
    """mul_scalar op compiled"""
...
def test_mul_scalar(shape, dtype):
    """
    Feature: Test op mul_scalar
    Description: Test op mul_scalar with multi-dimensional tensor inputs
