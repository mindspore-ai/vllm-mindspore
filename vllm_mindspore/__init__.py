...
vllm.worker.model_runner.GPUModelRunnerBase.__init__ = gpu_model_runner_base_init
...
from .config import get_head_size, _verify_quantization, get_num_kv_heads, _verify_args, _verify_cache_args
...
vllm.config.CacheConfig._verify_args = _verify_cache_args
