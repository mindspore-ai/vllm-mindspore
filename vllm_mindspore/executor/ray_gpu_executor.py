...
# Adapted from
# https://github.com/vllm-project/vllm/blob/v0.8.3/vllm/executor/ray_distributed_executor.py
#
...
def ms_init_workers_ray(self, placement_group, **ray_remote_kwargs):
