...
from vllm.engine.arg_utils import (_raise_or_fallback, EngineArgs, _warn_or_fallback,
                                   nullable_str, nullable_kvs, DEVICE_OPTIONS,
                                   ALLOWED_DETAILED_TRACE_MODULES)
from vllm.config import LoadFormat, ModelConfig, TaskOption
...
from vllm.config import (CompilationConfig, ConfigFormat, KVTransferConfig, LoadFormat,
                         ModelConfig, ModelImpl, PoolerConfig, TaskOption)
from vllm.reasoning import ReasoningParserManager
from vllm.utils import FlexibleArgumentParser, StoreBoolean

from vllm_mindspore.model_executor.layers.quantization import QUANTIZATION_METHODS
