...
#     # def commit(self):
#     #     # self.token_ids_cpu_tensor.copy_(torch.from_numpy(self.token_ids_cpu))
#     #     self.temperature_cpu_tensor.copy_(torch.from_numpy(self.temperature_cpu))
#     #     self.top_p_cpu_tensor.copy_(torch.from_numpy(self.top_p_cpu))
#     #     self.top_k_cpu_tensor.copy_(torch.from_numpy(self.top_k_cpu))
#     #     self.min_p_cpu_tensor.copy_(torch.from_numpy(self.min_p_cpu))
#     #     self.frequency_penalties_cpu_tensor.copy_(torch.from_numpy(self.frequency_penalties_cpu))
#     #     self.presence_penalties_cpu_tensor.copy_(torch.from_numpy(self.presence_penalties_cpu))
#     #     self.repetition_penalties_cpu_tensor.copy_(torch.from_numpy(self.repetition_penalties_cpu))
...
#             num_tokens = int(num_tokens) # numpy.int32 -> python int
...
#         copy_slice(torch.from_numpy(self.temperature_cpu), self.temperature, num_reqs)
...
#         return prompt_token_ids_cpu_tensor.clone()
