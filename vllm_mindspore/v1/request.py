...
def wrapper_request_init(fun):
    """
    Wrap the Request __init__ to prevent memory leaks caused
    by circular references from block_hasher.

    Use weakref.proxy for self so the partial won't hold a
    strong reference, avoiding memory leaks.
    """
