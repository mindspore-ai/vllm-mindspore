...
def get_masked_input_and_mask(
    ...
    added_offset = mint.sub(mint.sub(added_vocab_start_index, mint.sub(
        org_vocab_end_index, org_vocab_start_index)), num_org_vocab_padding)
    valid_offset = mint.add(mint.mul(org_vocab_start_index,
                    org_vocab_mask), mint.mul(added_offset, added_vocab_mask))
