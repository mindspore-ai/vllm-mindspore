...
from vllm_mindspore.model_executor.models.mf_models.deepseekv3_weight_processor import \
...
class DeepseekV3ForCausalLM(MfModelBase):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = "") -> None:
        ...
        if envs.VLLM_USE_V1:
            self.kv_caches = [
                Fake_MLA_V1() for i in range(self.mf_model_config.num_layers)
            ]
        else:
            self.kv_caches = [
                Fake_MLA() for i in range(self.mf_model_config.num_layers)
            ]
    ...
    def _generate_model_config(self):
        ...
        setattr(self.mf_model_config, 'npu_mem_size', -1)  # noqa B010
    ...
    def get_model_path(self):
        ...
        if os.path.isdir(model_name_or_path):
            ...
            raise ValueError(
                "The 'model' in LLM should be the local path of the MindSpore checkpoint file."
            )
