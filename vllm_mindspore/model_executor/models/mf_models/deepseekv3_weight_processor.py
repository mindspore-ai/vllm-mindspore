...
class DeepseekV3WeightProcessor(BaseWeightProcessor):
    ...
    def get_moe_shared_expert_weight_a8w4(self, w1_weight_name, w1_scale_name,
        ...
        if self.ep_method in [EPMethod.DEFAULT, EPMethod.ALLGATHER]:
            w1_weight_param, _ = (
                self.get_safetensor_from_file_split_tpdp_group(w1_weight_name,
                                                               src_hf_dir,
                                                               hf_weight_map,
                                                               split_axis=0))
            w1_scale_param, _ = (
                self.get_safetensor_from_file_split_tpdp_group(w1_scale_name,
                                                               src_hf_dir,
                                                               hf_weight_map,
                                                               split_axis=0))
            w3_weight_param, _ = (
                self.get_safetensor_from_file_split_tpdp_group(w3_weight_name,
                                                               src_hf_dir,
                                                               hf_weight_map,
                                                               split_axis=0))
            w3_scale_param, _ = (
                self.get_safetensor_from_file_split_tpdp_group(w3_scale_name,
                                                               src_hf_dir,
                                                               hf_weight_map,
                                                               split_axis=0))
            w2_weight_param, _ = (
                self.get_safetensor_from_file_split_tpdp_group(w2_weight_name,
                                                               src_hf_dir,
                                                               hf_weight_map,
                                                               split_axis=1))
        elif self.ep_method == EPMethod.ALLTOALL:
