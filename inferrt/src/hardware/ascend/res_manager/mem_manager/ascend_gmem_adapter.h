...
#ifndef INFERRT_SRC_HARDWARE_ASCEND_ASCEND_GMEM_ADAPTER_H_
#define INFERRT_SRC_HARDWARE_ASCEND_ASCEND_GMEM_ADAPTER_H_
...
class AscendGmemAdapter {
 ...
 public:
  ...
  inline const bool is_eager_free_enabled() const { return isEagerFreeEnabled_; }
