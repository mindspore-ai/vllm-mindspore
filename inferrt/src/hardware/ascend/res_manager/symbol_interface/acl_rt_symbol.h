 ...
 */
#ifndef INFERRT_SRC_HARDWARE_ASCEND_ACL_RT_SYMBOL_H_
#define INFERRT_SRC_HARDWARE_ASCEND_ACL_RT_SYMBOL_H_
#include <string>
...
#endif  // INFERRT_SRC_HARDWARE_ASCEND_ACL_RT_SYMBOL_H_
