 ...
 */
#ifndef OPS_ASCEND_HCCL_REDUCE_SCATTER_H_
#define OPS_ASCEND_HCCL_REDUCE_SCATTER_H_
#include <vector>
...
namespace mrt {
namespace ops {
class HcclReduceScatter : public OpReduceScatter {
 public:
...
#endif  // OPS_ASCEND_HCCL_REDUCE_SCATTER_H_
