...
#ifndef OPS_ASCEND_HCCL_BROADCAST_H_
#define OPS_ASCEND_HCCL_BROADCAST_H_
...
namespace mrt {
namespace ops {
class HcclBroadcast : public OpBroadcast {
 public:
  HcclBroadcast() = default;
  ~HcclBroadcast() override = default;
...
#endif  // OPS_ASCEND_HCCL_BROADCAST_H_
