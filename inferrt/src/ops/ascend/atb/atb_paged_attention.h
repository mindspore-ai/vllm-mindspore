...
#ifndef __OPS_ASCEND_ATB_ATB_PAGED_ATTENTION_H__
#define __OPS_ASCEND_ATB_ATB_PAGED_ATTENTION_H__
...
class AtbPagedAttention : public AtbBase {
 public:
  AtbPagedAttention();
  ~AtbPagedAttention() override = default;
