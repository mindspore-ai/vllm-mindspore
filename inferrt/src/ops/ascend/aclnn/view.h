...
#ifndef __OPS_ASCEND_ACLNN_ACLNN_VIEW_H__
#define __OPS_ASCEND_ACLNN_ACLNN_VIEW_H__
...
namespace mrt {
namespace ops {
class AclnnView : public AclnnViewBase {
 public:
  AclnnView() = default;
  ~AclnnView() override = default;
...
#endif  // __OPS_ASCEND_ACLNN_ACLNN_VIEW_H__
