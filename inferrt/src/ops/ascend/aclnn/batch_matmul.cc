...
#include "ops/ascend/aclnn/batch_matmul.h"
#include "ops/ascend/aclnn/utils/opapi_utils.h"
#include "ops/op_register.h"

namespace mrt {
namespace ops {
OpsErrorCode AclnnBatchMatmul::CalcWorkspace(const std::vector<const ir::Value *> &input, const ir::Value *output,
...
OpsErrorCode AclnnBatchMatmul::Launch(const std::vector<const ir::Value *> &input, void *workspace,
...
MRT_REG_OP(batch_matmul, AclnnBatchMatmul, Ascend);
}  // namespace ops
}  // namespace mrt
