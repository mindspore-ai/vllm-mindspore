...
#ifndef __OPS_ASCEND_ACLNN_ACLNN_ZEROS_H__
#define __OPS_ASCEND_ACLNN_ACLNN_ZEROS_H__
...
namespace mrt {
namespace ops {
class AclnnZeros : public Operator {
 public:
  AclnnZeros() { executor_ = std::make_unique<AclnnExecutor>("aclnnInplaceZero"); }
  ~AclnnZeros() override = default;
...
#endif  // __OPS_ASCEND_ACLNN_ACLNN_ZEROS_H__
