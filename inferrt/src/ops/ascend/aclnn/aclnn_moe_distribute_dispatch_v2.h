...
#ifndef __OPS_ASCEND_ACLNN_ACLNN_MOE_DISTRIBUTE_DISPATCH_V2_H__
#define __OPS_ASCEND_ACLNN_ACLNN_MOE_DISTRIBUTE_DISPATCH_V2_H__
...
namespace mrt {
namespace ops {
class AclnnMoeDistributeDispatchV2 : public Operator {
 public:
  AclnnMoeDistributeDispatchV2();
  ~AclnnMoeDistributeDispatchV2() override = default;
...
#endif  // __OPS_ASCEND_ACLNN_ACLNN_MOE_DISTRIBUTE_DISPATCH_V2_H__
