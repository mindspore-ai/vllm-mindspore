...
#ifndef __OPS_ASCEND_ACLNN_ACLNN_MM_H__
#define __OPS_ASCEND_ACLNN_ACLNN_MM_H__
...
namespace mrt {
namespace ops {
class AclnnMm : public Operator {
 public:
  AclnnMm() { executor_ = std::make_unique<AclnnExecutor>("aclnnMm"); }
  ~AclnnMm() override = default;
...
#endif  // __OPS_ASCEND_ACLNN_ACLNN_MM_H__
