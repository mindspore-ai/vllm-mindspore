...
#ifndef __OPS_ASCEND_ACLNN_ACLNN_APPLY_ROTARY_POS_EMB_H__
#define __OPS_ASCEND_ACLNN_ACLNN_APPLY_ROTARY_POS_EMB_H__
...
namespace mrt {
namespace ops {
class AclnnApplyRotaryPosEmb : public Operator {
 public:
  AclnnApplyRotaryPosEmb() { executor_ = std::make_unique<AclnnExecutor>("aclnnApplyRotaryPosEmb"); }
  ~AclnnApplyRotaryPosEmb() override = default;
...
#endif  // __OPS_ASCEND_ACLNN_ACLNN_APPLY_ROTARY_POS_EMB_H__
