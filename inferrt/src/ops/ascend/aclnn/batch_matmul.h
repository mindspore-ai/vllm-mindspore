...
#ifndef __OPS_ASCEND_ACLNN_ACLNN_BATCH_MATMUL_H__
#define __OPS_ASCEND_ACLNN_ACLNN_BATCH_MATMUL_H__
...
namespace mrt {
namespace ops {
class AclnnBatchMatmul : public Operator {
 public:
  AclnnBatchMatmul() { executor_ = std::make_unique<AclnnExecutor>("aclnnBatchMatMul"); }
  ~AclnnBatchMatmul() override = default;
...
#endif  // __OPS_ASCEND_ACLNN_ACLNN_BATCH_MATMUL_H__
