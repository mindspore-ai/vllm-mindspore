...
namespace mrt {
namespace ops {
OpsErrorCode AclnnMm::CalcWorkspace(const std::vector<const ir::Value *> &input, const ir::Value *output,
...
OpsErrorCode AclnnMm::Launch(const std::vector<const ir::Value *> &input, void *workspace, size_t workspaceSize,
