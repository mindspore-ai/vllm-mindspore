...
#ifndef __OPS_ASCEND_ACLNN_COMPOSITE_MASKED_FILL_TENSOR_H__
#define __OPS_ASCEND_ACLNN_COMPOSITE_MASKED_FILL_TENSOR_H__
...
namespace mrt {
namespace ops {
class AclnnMaskedFillTensor : public Operator {
 public:
  AclnnMaskedFillTensor() {
    executorCopy_ = std::make_unique<AclnnExecutor>("aclnnInplaceCopy");
    executor_ = std::make_unique<AclnnExecutor>("aclnnInplaceMaskedFillTensor");
  }
  ~AclnnMaskedFillTensor() override = default;
...
#endif  // __OPS_ASCEND_ACLNN_COMPOSITE_MASKED_FILL_TENSOR_H__
