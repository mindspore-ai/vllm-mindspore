...
namespace mrt {
namespace ops {
class AclnnScatterNdUpdate : public Operator {
 public:
  AclnnScatterNdUpdate() { executor_ = std::make_unique<AclnnExecutor>("aclnnScatterNdUpdate"); }
  ~AclnnScatterNdUpdate() override = default;
