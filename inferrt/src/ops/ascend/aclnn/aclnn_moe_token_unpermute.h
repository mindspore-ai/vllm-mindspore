...
#ifndef __OPS_ASCEND_ACLNN_ACLNN_MOE_TOKEN_UNPERMUTE_H__
#define __OPS_ASCEND_ACLNN_ACLNN_MOE_TOKEN_UNPERMUTE_H__
...
namespace mrt {
namespace ops {
class AclnnMoeTokenUnpermute : public Operator {
 public:
  AclnnMoeTokenUnpermute() { executor_ = std::make_unique<AclnnExecutor>("aclnnMoeTokenUnpermute"); }
  ~AclnnMoeTokenUnpermute() override = default;
...
#endif  // __OPS_ASCEND_ACLNN_ACLNN_MOE_TOKEN_UNPERMUTE_H__
