...
#ifndef MOPT_CONVERSION_COMMON_TO_MRT_ARITH_TO_MRT_H
#define MOPT_CONVERSION_COMMON_TO_MRT_ARITH_TO_MRT_H
...
#endif  // MOPT_CONVERSION_COMMON_TO_MRT_ARITH_TO_MRT_H
